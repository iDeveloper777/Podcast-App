...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func initStoryboard() {
        ...
        let rootNavi = storyboard.instantiateViewControllerWithIdentifier("RootNavi") as! UINavigationController
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        if sharedAppDelegate == nil{
            sharedAppDelegate = UIApplication.sharedApplication().delegate as? AppDelegate
        }
